...
CREATE TABLE IF NOT EXISTS payment_config (
  ...
  business    TEXT DEFAULT 'Casino Hacks',
...
-- customer support contacts shown to members: {whatsapp, email, telegram}
ALTER TABLE payment_config ADD COLUMN IF NOT EXISTS support JSONB NOT NULL DEFAULT '{}'::jsonb;
